                    ...
                    <a href="internship.html" target="_blank" class="popup-bubble" style="text-decoration: none; color: inherit; display: flex; align-items: center; cursor: pointer;">
                        ...
                        <span class="mobile-text">
                            ...
                            <span class="banner-actions" style="display: flex; opacity: 0; width: 0; overflow: hidden; align-items: center; gap: 10px; transition: all 0.5s cubic-bezier(0.16, 1, 0.3, 1);">
                                <span class="banner-btn" style="white-space: nowrap; background: white; color: #d6aa31; padding: 6px 12px; border-radius: 12px; font-size: 0.8rem; text-decoration: none; font-weight: bold;">Know More &rarr;</span>
                                <button class="popup-close-btn" style="background: none; border: none; color: white; opacity: 0.9; font-size: 1.2rem; cursor: pointer; padding: 0; z-index: 10;"><i class="fas fa-times"></i></button>
                            </span>
                        </span>
                    </a>
                `;
